...
const parks = [
  {
    ...
    country: "Indonesia",
    image: `${import.meta.env.BASE_URL}Images/komodo.jpg`,
    description: "Komodo National Park lies between the islands of Sumbawa and Flores and includes the major islands of Komodo, Rinca and Padar alongside many smaller volcanic islands. It was established to protect the Komodo dragon, the world's largest living lizard and a species found nowhere else in the wild. Rugged hills covered in dry savanna contrast with white beaches and clear tropical water. The park also protects rich coral reefs inhabited by sea turtles, dolphins, dugongs, whales and an exceptional diversity of fish. Its location within the Wallacea region brings together species with both Asian and Australian origins. Komodo was inscribed on the UNESCO World Heritage List in 1991 for its extraordinary landscapes and biodiversity.",
    established: 1980,
    area: "1,733 km²",
    elevation: "735 m",
    visitors: "~432K (2025)",
...

  {
    ...
    location: "Galway,",
    country: "Ireland",
    image: `${import.meta.env.BASE_URL}Images/connemara.jpg`,
    description: "Connemara National Park protects a rugged landscape of mountains, western blanket bog, heathland, grassland and woodland in County Galway. Several peaks within the park belong to the Twelve Bens range, including Benbaun, the highest mountain in County Galway. Its quartzite summits and valleys were shaped by ancient geological forces and the glaciers of the last ice age. The park's lands once formed part of the Kylemore Abbey Estate, the Letterfrack Industrial School and other private estates. Red deer, native birds and heritage breeds such as the Connemara pony and Old Irish Goat can be encountered across its varied habitats. Opened to the public in 1980, the park now offers walking trails centred around Letterfrack and Diamond Hill.",
    established: 1980,
    area: "20 km²",
    elevation: "725 m",
    visitors: "~259K (2023)",
  ...
  {
    name: "Göreme",
    type: "Historical National Park",
    location: "Nevşehir Province,",
    country: "Turkey",
    image: `${import.meta.env.BASE_URL}Images/goreme.jpg`,
    description: "Göreme lies in Cappadocia, where erosion has sculpted soft volcanic rock into valleys, ridges and the famous formations known as fairy chimneys. People carved homes, monasteries and entire settlements into this landscape from at least the 4th century. The valley contains an exceptional concentration of rock-cut churches decorated with Byzantine frescoes. Underground cities such as Kaymaklı and Derinkuyu provided refuge and formed part of the wider cultural landscape. The interaction between natural erosion and centuries of human settlement gives Göreme both geological and historical importance. Göreme National Park and the Rock Sites of Cappadocia were inscribed on the UNESCO World Heritage List in 1985.",
    established: 1986,
    area: "96 km²",
    elevation: "1,104 m",
    visitors: "~1.2M (2025)",
...

  {
    ...
    country: "Poland",
    image: `${import.meta.env.BASE_URL}Images/tatra.jpg`,
    description: "Tatra National Park protects the Polish side of the Tatra Mountains, the country's only landscape with a fully alpine character. Its terrain rises from forested valleys to jagged peaks, with Rysy reaching 2,499 metres on the Polish-Slovak border. Glaciers shaped the park's steep valleys, mountain lakes and many caves during the last ice age. Changes in altitude create distinct vegetation zones ranging from beech and fir forests to dwarf pine and alpine grasslands. The mountains provide habitat for Tatra chamois, marmots, brown bears, golden eagles and other specialised wildlife. Established in 1955, the park shares a UNESCO transboundary biosphere reserve with the neighbouring Tatra National Park in Slovakia.",
    established: 1955,
    area: "212 km²",
    elevation: "2,499 m",
    visitors: "~5M (2025)",
